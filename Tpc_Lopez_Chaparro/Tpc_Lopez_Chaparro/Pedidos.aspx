<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pedidos.aspx.cs" Inherits="Tpc_Lopez_Chaparro.Pedidos" %>
...
<header>
	...
	<table class="table">
            ...
            <div>
                <% foreach (Dominio.Carta item in listaPedido)
                    { %>
            <tbody>
                <tr>
					<td><%=item.Nombre %></td>
