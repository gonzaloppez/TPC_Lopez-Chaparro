<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Nosotros.aspx.cs" Inherits="Tpc_Lopez_Chaparro.Nosotros" %>
...
<header>
    ...
    <div class="container">
    <div class="col-md-6">
        <h1>Celebrando la buena vida a través de la comida saludable todo el año</h1>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>Neuhaus es un restaurant de Contemporary American Cuisine. El primer Restaurant fue inaugurado en Junio de 1999 en San Isidro</p>
                    <br />
                    <p>Nuestra visión es aportar alimentos de calidad en un ambiente placentero a través de un servicio excelente.</p>
                    <br />
                    <p>En Neuhaus creemos que la base para preparar un buen plato se encuentra en la calidad de los ingredientes que lo componen. Por eso, mantenemos una relación estrecha con nuestros proveedores para asegurarnos de recibir los mejores productos frescos disponibles en el mercado. Con la ayuda de éstos, preparamos, diariamente y con el mayor cuidado, los platos que servimos.</p>
                    <br />
					<p>En Neuhaus consideramos que la música, la arquitectura y la decoración son componentes esenciales de la experiencia gastronómica. Fundimos todos estos elementos para crear un ambience placentero que exalte las sensaciones del paladar. Cada uno de nuestros locales tiene su propio carácter: en su construcción se ha prestado especial atención a los materiales utilizados y al diseño de sus espacios interiores.</p>
                    <br />
					<p>En Neuhaus estamos deseosos de satisfacer la confianza que los clientes nos depositan. Procuramos prestar atención a los más pequeños detalles para lograr un servicio rápido y eficiente que supere todas las expectativas.</p>
                    <br />
					<p>Esperamos verlos pronto, disfrutando de “la nueva experiencia”.</p>
				</div>
				<div class="col-md-6">
					<img src="Content/resto.jpg"" class="img"/>
										<img src="Content/resto1.jpg"" class="img1"/>
